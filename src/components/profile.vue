<template>
    <div class="container">
        ...
        <div class="row">
            ...
            <h2>Name</h2>
            <br>
            <h4 v-if="name_flag">{{name}}</h4>
            <b-input  :type="'text'" v-if="!name_flag" v-model="name"></b-input>
            <br>
            ...
            <h2>E-Mail</h2>
            <br>
            <h4 v-if="email_flag">{{email}}</h4>
            <b-input  :type="'text'" v-if="!email_flag" v-model="email"></b-input>
            <br>
        ...
        <div class="row">
           <div class="col-lg-5 col-md-6 col-sm-12 card">
            ...
            <h2>Password</h2>
            <br>
            <h4 v-if="password_flag">{{password}}</h4>
            <b-input  :type="'text'" v-if="!password_flag" v-model="password"></b-input>
            <br>
            ...
            <h2>Country</h2>
            <br>
            <h4 v-if="country_flag">{{country}}</h4>
            <b-input  :type="'text'" v-if="!country_flag" v-model="country"></b-input>
            <br>
